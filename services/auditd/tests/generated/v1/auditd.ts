...
function createBaseIdentityExternalLinkAuditDetail(): IdentityExternalLinkAuditDetail {
  return { externalLinkId: "", providerId: "", humanAccountPrincipalId: "", action: 0 };
}
...
export const IdentityExternalLinkAuditDetail: MessageFns<IdentityExternalLinkAuditDetail> = {
  encode(message: IdentityExternalLinkAuditDetail, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.externalLinkId !== "") {
      writer.uint32(10).string(message.externalLinkId);
    }
    if (message.providerId !== "") {
      writer.uint32(18).string(message.providerId);
    }
    if (message.humanAccountPrincipalId !== "") {
      writer.uint32(26).string(message.humanAccountPrincipalId);
    }
    if (message.action !== 0) {
      writer.uint32(32).int32(message.action);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.externalLinkId = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): IdentityExternalLinkAuditDetail {
    return {
      externalLinkId: isSet(object.externalLinkId) ? globalThis.String(object.externalLinkId) : "",
  ...
  toJSON(message: IdentityExternalLinkAuditDetail): unknown {
    const obj: any = {};
    if (message.externalLinkId !== "") {
      obj.externalLinkId = message.externalLinkId;
    }
    if (message.providerId !== "") {
  ...
  fromPartial(object: DeepPartial<IdentityExternalLinkAuditDetail>): IdentityExternalLinkAuditDetail {
    const message = createBaseIdentityExternalLinkAuditDetail();
    message.externalLinkId = object.externalLinkId ?? "";
