...
const expectedDetailRows = new Map([
  ...
  ["audit_identity_memberships", 2],
  ["audit_identity_groups", 2],
  ["audit_identity_group_members", 2],
  ["audit_identity_virtual_principals", 2],
  ["audit_identity_external_links", 2],
  ["audit_identity_login_providers", 4],
  ["audit_identity_workspace_provider_admissions", 2],
