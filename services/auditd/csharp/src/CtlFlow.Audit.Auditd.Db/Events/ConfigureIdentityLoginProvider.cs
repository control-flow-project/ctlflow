...
{
    internal static void ConfigureIdentityLoginProvider(
        ModelBuilder modelBuilder)
    {
        var detail =
            modelBuilder.Entity<IdentityLoginProviderAuditDetail>();
        detail.ToTable("audit_identity_login_providers");
        ...
        detail.HasOne<AuditRecord>()
            .WithOne()
            .HasForeignKey<IdentityLoginProviderAuditDetail>(
        ...
        detail.Property(value => value.ProviderId)
            ...
            .HasMaxLength(64)
            .IsRequired();
        detail.Property(value => value.ProviderRevision)
