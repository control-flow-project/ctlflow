...
internal static partial class ModelAudits
{
    ...
    [
        "AuditPartitionHead.CurrentCursor"
    ];
    ...
    internal static async Task AuditModel(
        string databasePath,
        CancellationToken cancellation)
    {
        ...
        var database = await CreateAuditDatabase(
        ...
        Require(
            ...
            "The auditd model is not using the SQLite provider");
        Require(
            context.Model.GetType().FullName
                == "CtlFlow.Audit.Auditd.Db.Generated.AuditDbContextModel",
            "The generated auditd compiled model was not selected");
