...
process.stdout.write("edged evidence manifest verified\n");
...
function parseManifest(value) {
  ...
  assert(
    ...
    "Edged evidence manifest shape is invalid");
  verifyReleaseGates(value.releaseGates, "edged", false);
  return {
