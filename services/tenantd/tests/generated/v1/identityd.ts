...
export interface GetWorkspaceLoginProviderAdmissionRequest {
  tenantId: string;
  workspaceId: string;
  providerId: string;
}
...
function createBaseGetWorkspaceLoginProviderAdmissionRequest(): GetWorkspaceLoginProviderAdmissionRequest {
  return { tenantId: "", workspaceId: "", providerId: "" };
}

export const GetWorkspaceLoginProviderAdmissionRequest: MessageFns<GetWorkspaceLoginProviderAdmissionRequest> = {
  encode(message: GetWorkspaceLoginProviderAdmissionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tenantId !== "") {
      writer.uint32(10).string(message.tenantId);
    }
    if (message.workspaceId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetWorkspaceLoginProviderAdmissionRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetWorkspaceLoginProviderAdmissionRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GetWorkspaceLoginProviderAdmissionRequest {
    return {
      tenantId: isSet(object.tenantId) ? globalThis.String(object.tenantId) : "",
      workspaceId: isSet(object.workspaceId) ? globalThis.String(object.workspaceId) : "",
      providerId: isSet(object.providerId) ? globalThis.String(object.providerId) : "",
  ...
  toJSON(message: GetWorkspaceLoginProviderAdmissionRequest): unknown {
    const obj: any = {};
    if (message.tenantId !== "") {
      obj.tenantId = message.tenantId;
    }
  ...
  create(base?: DeepPartial<GetWorkspaceLoginProviderAdmissionRequest>): GetWorkspaceLoginProviderAdmissionRequest {
    return GetWorkspaceLoginProviderAdmissionRequest.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<GetWorkspaceLoginProviderAdmissionRequest>,
...
export const IdentityServiceService = {
  ...
  getWorkspaceLoginProviderAdmission: {
    path: "/ctlflow.identity.v1.IdentityService/GetWorkspaceLoginProviderAdmission",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetWorkspaceLoginProviderAdmissionRequest): Buffer =>
      Buffer.from(GetWorkspaceLoginProviderAdmissionRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetWorkspaceLoginProviderAdmissionRequest =>
      GetWorkspaceLoginProviderAdmissionRequest.decode(value),
    responseSerialize: (value: WorkspaceLoginProviderAdmission): Buffer =>
      Buffer.from(WorkspaceLoginProviderAdmission.encode(value).finish()),
    responseDeserialize: (value: Buffer): WorkspaceLoginProviderAdmission =>
      WorkspaceLoginProviderAdmission.decode(value),
  },
...
export interface IdentityServiceServer extends UntypedServiceImplementation {
  ...
  setWorkspaceLoginProviderAdmission: handleUnaryCall<
    ...
    SetWorkspaceLoginProviderAdmissionResponse
  >;
  getWorkspaceLoginProviderAdmission: handleUnaryCall<
    GetWorkspaceLoginProviderAdmissionRequest,
...
export interface IdentityServiceClient extends Client {
  ...
  getWorkspaceLoginProviderAdmission(
    request: GetWorkspaceLoginProviderAdmissionRequest,
    callback: (error: ServiceError | null, response: WorkspaceLoginProviderAdmission) => void,
  ): ClientUnaryCall;
  getWorkspaceLoginProviderAdmission(
    request: GetWorkspaceLoginProviderAdmissionRequest,
    metadata: Metadata,
