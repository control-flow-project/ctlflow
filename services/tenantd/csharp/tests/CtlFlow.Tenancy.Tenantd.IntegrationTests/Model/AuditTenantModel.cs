...
internal static partial class ModelAudits
{
    ...
    internal static async Task AuditTenantModel(
        string databasePath,
        CancellationToken cancellation)
    {
        ...
        Require(
            ...
            "The tenantd model is not using the SQLite provider");
        Require(
            context.Model.GetType().FullName
                == "CtlFlow.Tenancy.Tenantd.Db.Generated.TenantDbContextModel",
            "The generated tenantd compiled model was not selected");
