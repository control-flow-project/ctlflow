...
internal static partial class TelemetryConfiguration
{
        ...
        TelemetrySettings settings)
    {
        ...
        {
            options.SetResourceBuilder(ConfigdTelemetry.CreateResource());
        ...
        builder.Services.AddSingleton<ConfigdTelemetry>(services =>
            new ConfigdTelemetry(
                settings,
                services.GetRequiredService<ILogger<ConfigdTelemetry>>()));
    }
}
