using CtlFlow.Configuration.Configd.Db;
...
internal static partial class ModelAudits
{
    ...
    [
        "ConfigurationResource._revision",
        "Projection._revision",
        "Secret._revision"
    ];
    ...
    internal static async Task AuditConfigurationModel(
        string databasePath,
        CancellationToken cancellation)
    {
        ...
        var database = await CreateConfigurationDatabase(
        ...
        Require(
            ...
            "The configd model is not using the SQLite provider");
        Require(
            context.Model.GetType().FullName
                == "CtlFlow.Configuration.Configd.Db.Generated."
                + "ConfigurationDbContextModel",
            "The generated configd compiled model was not selected");
