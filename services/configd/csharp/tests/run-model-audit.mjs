...
const modelAuditProject = path.join(
  testsRoot,
  "CtlFlow.Configuration.Configd.IntegrationTests",
  "CtlFlow.Configuration.Configd.IntegrationTests.csproj");
...
const modelAuditPublication = await publishCSharpService({
  ...
  executableName: "CtlFlow.Configuration.Configd.IntegrationTests"
});
...
const servicePublication = await publishCSharpService({
  ...
  executableName: "CtlFlow.Configuration.Configd.Service"
});
...
process.stdout.write("configd rejected an unimplemented database provider\n");
