...
internal static partial class TelemetryConfiguration
{
        ...
        TelemetrySettings settings)
    {
        ...
        {
            options.SetResourceBuilder(PolicydTelemetry.CreateResource());
        ...
        builder.Services.AddSingleton<PolicydTelemetry>(services =>
            new PolicydTelemetry(
                settings,
                services.GetRequiredService<ILogger<PolicydTelemetry>>()));
    }
}
