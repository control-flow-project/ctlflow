...
const modelAuditProject = path.join(
  testsRoot,
  "CtlFlow.Policy.Policyd.IntegrationTests",
  "CtlFlow.Policy.Policyd.IntegrationTests.csproj");
...
const serviceProject = path.join(
  csharpRoot,
  "src",
  "CtlFlow.Policy.Policyd.Service",
  "CtlFlow.Policy.Policyd.Service.csproj");
...
const modelAuditPublication = await publishCSharpService({
  ...
  executableName: "CtlFlow.Policy.Policyd.IntegrationTests"
});
...
const servicePublication = await publishCSharpService({
  ...
  executableName: "CtlFlow.Policy.Policyd.Service"
});
...
process.stdout.write("policyd rejected an unimplemented database provider\n");
