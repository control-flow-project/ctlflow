using CtlFlow.Execution.Execd.Db;
...
internal static partial class ModelAudits
{
    ...
    internal static async Task AuditExecutionModel(
        string databasePath,
        CancellationToken cancellation)
    {
        ...
        Require(
            ...
            "The execd model is not using the SQLite provider");
        Require(
            context.Model.GetType().FullName
                == "CtlFlow.Execution.Execd.Db.Generated.ExecutionDbContextModel",
            "The generated execd compiled model was not selected");
