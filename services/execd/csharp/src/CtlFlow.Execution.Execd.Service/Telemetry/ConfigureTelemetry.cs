...
internal static partial class TelemetryConfiguration
{
        ...
        TelemetrySettings settings)
    {
        ...
        {
            options.SetResourceBuilder(ExecdTelemetry.CreateResource());
        ...
        builder.Services.AddSingleton<ExecdTelemetry>(services =>
            new ExecdTelemetry(
                settings,
                services.GetRequiredService<ILogger<ExecdTelemetry>>()));
    }
}
