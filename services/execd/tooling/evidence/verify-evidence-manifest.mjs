...
const manifestService = "ctlflow.execution.v1.ExecutionService";
...
process.stdout.write("execd evidence manifest verified\n");
...
function parseManifest(value) {
  ...
  if (value.schemaVersion !== 1
    ...
    throw new Error("Execd evidence manifest shape is invalid");
  }

  verifyReleaseGates(value.releaseGates, "execd", true);
  return {
