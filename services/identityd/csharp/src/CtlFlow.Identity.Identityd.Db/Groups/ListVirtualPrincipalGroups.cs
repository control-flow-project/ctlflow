...
{
    private static async Task<GroupPage> ListVirtualPrincipalGroups(
        ...
        CancellationToken cancellation)
    {
        ...
        {
            rows = await database.VirtualPrincipalGroupMemberships
                .AsNoTracking()
                .Where(membership => EF.Property<string>(
                    membership,
                    "_principalId") == principalValue)
                .Join(
