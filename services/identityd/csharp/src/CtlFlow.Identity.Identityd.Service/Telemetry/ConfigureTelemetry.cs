...
internal static partial class TelemetryConfiguration
{
        ...
        TelemetrySettings settings)
    {
        ...
        {
            options.SetResourceBuilder(IdentitydTelemetry.CreateResource());
        ...
        builder.Services.AddSingleton<IdentitydTelemetry>(services =>
            new IdentitydTelemetry(
                settings,
                services.GetRequiredService<ILogger<IdentitydTelemetry>>()));
    }
}
