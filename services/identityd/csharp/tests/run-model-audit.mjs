...
const modelAuditProject = path.join(
  testsRoot,
  "CtlFlow.Identity.Identityd.IntegrationTests",
  "CtlFlow.Identity.Identityd.IntegrationTests.csproj");
...
const serviceProject = path.join(
  ...
  "CtlFlow.Identity.Identityd.Service.csproj");
...
const modelAuditPublication = await publishCSharpService({
  ...
  executableName: "CtlFlow.Identity.Identityd.IntegrationTests"
});
...
const servicePublication = await publishCSharpService({
  ...
  executableName: "CtlFlow.Identity.Identityd.Service"
});
...
process.stdout.write("identityd rejected an unimplemented database provider\n");
