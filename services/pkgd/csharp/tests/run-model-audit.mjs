...
const databasePath = path.join(directory, "pkgd.sqlite");
const modelAuditProject = path.join(
  testsRoot,
  "CtlFlow.Packages.Pkgd.IntegrationTests",
  "CtlFlow.Packages.Pkgd.IntegrationTests.csproj");
...
const serviceProject = path.join(
  ...
  "CtlFlow.Packages.Pkgd.Service.csproj");
...
const modelAuditPublication = await publishCSharpService({
  ...
  executableName: "CtlFlow.Packages.Pkgd.IntegrationTests"
});
...
const servicePublication = await publishCSharpService({
  ...
  executableName: "CtlFlow.Packages.Pkgd.Service"
});
...
process.stdout.write("pkgd rejected an unimplemented database provider\n");
