...
internal static partial class ModelAudits
{
    ...
    internal static async Task AuditPackageModel(
        string databasePath,
        CancellationToken cancellation)
    {
        ...
        var database = await CreatePackageDatabase(
        ...
        Require(
            ...
            "The pkgd model is not using the SQLite provider");
        Require(
            context.Model.GetType().FullName
                == "CtlFlow.Packages.Pkgd.Db.Generated.PackageDbContextModel",
            "The generated pkgd compiled model was not selected");
