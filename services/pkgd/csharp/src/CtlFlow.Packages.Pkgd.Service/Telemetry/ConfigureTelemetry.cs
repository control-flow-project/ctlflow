...
internal static partial class TelemetryConfiguration
{
        ...
        TelemetrySettings settings)
    {
        ...
        {
            options.SetResourceBuilder(PkgdTelemetry.CreateResource());
        ...
        builder.Services.AddSingleton<PkgdTelemetry>(services =>
            new PkgdTelemetry(
                settings,
                services.GetRequiredService<ILogger<PkgdTelemetry>>()));
    }
}
