...
export interface PkgdContextFiles {
...
export interface PreparePkgdContextFilesOptions {
...
export async function preparePkgdContextFiles(
  options: PreparePkgdContextFilesOptions
): Promise<PkgdContextFiles> {
